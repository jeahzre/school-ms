...
<main>
  ...
  <div class="main-content">
    <div class="card">
      ...
      <form class="form" method="post" action="/model/Student.php">
        <div class="labels-inputs-vertical">
          <div class="label-input">
            <label for="add_name">Name</label>
            <input type="text" name="add_name" id="add_name" placeholder="Name" class="add_student" autocomplete="username">
          </div>
          <div class="label-input">
            <label for="add_name">Initial Name</label>
            <input type="text" name="add_initial_name" id="add_initial_name" placeholder="Initial Name" class="add_student">
          </div>
          <div class="label-input">
            <div>Gender</div>
            <div class="labels-inputs-horizontal inner-labels-inputs">
              <div class="label-input">
                <input type="radio" name="add_gender" value="male" id="add_male" class="add_student">
                <label for="add_male">Male</label>
              </div>
              <div class="label-input">
                <input type="radio" name="add_gender" value="female" id="add_female" class="add_student">
          ...
          <div class="label-input">
            ...
            <input type="text" name="add_phone_number" id="add_phone_number" placeholder="Phone Number" class="add_student">
          </div>
          <div class="label-input">
            <label for="add_email">Email</label>
            <input type="email" name="add_email" id="add_email" placeholder="Email" class="add_student">
          </div>
          <div class="label-input">
            <label for="add_passwd">Password</label>
            <input type="text" name="add_passwd" id="add_passwd" placeholder="Password" class="add_student">
          </div>
          <div class="label-input">
            <label for="add_guardian_name">Guardian Name</label>
            <input type="text" name="add_guardian_name" id="add_guardian_name" placeholder="Guardian Name" class="add_student">
          </div>
          <div class="label-input">
            <label for="add_guardian_phone">Guardian Phone</label>
            <input type="text" name="add_guardian_phone" id="add_guardian_phone" placeholder="Guardian Phone" class="add_student">
          </div>
          <div class="label-input">
            <label for="add_guardian_email">Guardian Email</label>
            <input type="text" name="add_guardian_email" id="add_guardian_email" placeholder="Guardian Email" class="add_student">
          </div>
        </div>
      ...
      <div class="content">
        <table class="labels-inputs-table">
          <tr class="label-input">
            ...
            <td>
              <input type="text" name="edit_id" id="edit_id" class="edit_student">
            </td>
          </tr>
          <tr class="label-input">
            <td>
            ...
            <td>
              <input type="text" name="edit_name" id="edit_name" class="edit_student">
            </td>
          </tr>
          <tr class="label-input">
            <td>
            ...
            <td>
              <input type="text" name="edit_initial_name" id="edit_initial_name" class="edit_student">
            </td>
          </tr>
          <tr class="label-input">
            <td>
            ...
            <td>
              <div class="labels-inputs-horizontal">
                <div class="label-input">
                  <input type="radio" name="edit_gender" value="male" id="edit_male" class="edit_student">
                  <label for="edit_male">Male</label>
                  <input type="radio" name="edit_gender" value="female" id="edit_female" class="edit_student">
          ...
          <tr class="label-input">
            ...
            <td>
              <input type="number" name="edit_phone_number" id="edit_phone_number" class="edit_student">
            </td>
          </tr>
          <tr class="label-input">
            <td>
            ...
            <td>
              <input type="email" name="edit_email" id="edit_email" placeholder="Email" class="edit_student">
            </td>
          </tr>
          <tr class="label-input">
            <td>
            ...
            <td>
              <input type="password" name="edit_passwd" id="edit_passwd" placeholder="Password" class="edit_student">
            </td>
          </tr>
          <tr class="label-input">
            <td>
            ...
            <td>
              <input type="text" name="edit_guardian_name" id="edit_guardian_name" placeholder="Guardian Name" class="edit_student">
            </td>
          </tr>
          <tr class="label-input">
            <td>
            ...
            <td>
              <input type="number" name="edit_guardian_phone" id="edit_guardian_phone" placeholder="Guardian Phone" class="edit_student">
            </td>
          </tr>
          <tr class="label-input">
            <td>
            ...
            <td>
              <input type="text" name="edit_guardian_email" id="edit_guardian_email" placeholder="Guardian Email" class="edit_student">
            </td>
          </tr>
        </table>
...
<script>
  let _global_ = {
    item: 'student',
    itemIdName: 'id',
    listModelFile: 'Student',
    itemKeysForEdit: ['id', 'name', 'initial_name', 'gender', 'phone_number', 'email', 'passwd', 'guardian_name', 'guardian_phone', 'guardian_email'],
...
<script>
  function renderRow(data) {
    ...
    trElement.innerHTML = `
      ...
      <td class='guardian_name' data-value='${guardian_name}'>${guardian_name}</td>
      <td class='guardian_phone' data-value='${guardian_phone}'>${guardian_phone}</td>
      <td class='guardian_email' data-value='${guardian_email}'>${guardian_email}</td>
      <td>
