...
<main>
  ...
  <div class="main-content">
    <div class="card">
      <div class="title">Add Student Attendance</div>
      <form class="form" method="POST" action="/model/StudentAttendance.php">
        <div class="labels-inputs-horizontal">
          <div class="label-input">
            <label for="add_user_id">User ID</label>
            <input type="number" name="add_user_id" id="add_user_id" placeholder="User ID" class="add_student_attendance">
          </div>
          <div class="label-input">
            <label for="add_date">Date</label>
            <input type="date" name="add_date" id="add_date" placeholder="Date" class="add_student_attendance">
          </div>
        </div>
    ...
    <div class="modal" id="edit-item-modal">
      ...
      <div class="title">Edit Student Attendance</div>
      <div class="content">
        <table class="labels-inputs-table">
          <tr class="label-input">
            ...
            <td>
              <input type="number" name="edit_user_id" id="edit_user_id" class="edit_student_attendance">
            </td>
          </tr>
          <tr class="label-input">
            <td>
            ...
            <td>
              <input type="date" name="edit_date" id="edit_date" class="edit_student_attendance">
            </td>
          </tr>
        </table>
...
<script>
  let _global_ = {
    ...
    itemIdName: ['user_id'],
    listModelFile: 'StudentAttendance',
    itemKeysForEdit: ['user_id', 'date']
  }
</script>
...
<script>
  function renderRow(data) {
    ...
    trElement.innerHTML = `
      ...
      <td class='date' data-value='${date}'>${date}</td>
      <td>
